(window as any).huozi = require('huozi').default;
require('./libs/pegjs/parser.js');
...
export function parseRichText(text: string, sprite: any): Array<string> {
  var now = performance.now();
  const ast = UBBParser.parse(text);
